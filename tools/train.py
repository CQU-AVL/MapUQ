...
# Ensure project root is on PYTHONPATH for local package imports
PROJECT_ROOT = os.path.dirname(os.path.dirname(__file__))
if PROJECT_ROOT not in sys.path:
    sys.path.insert(0, PROJECT_ROOT)
# Avoid accidentally importing plugins from the legacy MapTR-maptrv2 repo
sys.path = [p for p in sys.path if 'MapTR-maptrv2' not in str(p)]
